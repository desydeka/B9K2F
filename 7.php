<?php
	...
	Class conn
	{
		...
		{
			$this->conn = new mysqli('localhost', 'root', '', 'gudang');
		}
  						...
  						<caption>List of products</caption>
							...
							<tbody>
								<form class='form-horizontal' role='form' method='POST'>
									<?php
										$data = $conn->select('products.id as id, products.name as name, categories.name as category, products.category_id', 'products INNER JOIN categories ON products.category_id = categories.id');
										...
										echo	"<tr>
														...
														<td>
															<select class='custom-select custom-select-sm' name='category'>
																...
																<option value='2' ".($baris[3] == 2 ? "selected" : "").">Mie Instan</option>
																<option value='3' ".($baris[3] == 3 ? "selected" : "").">Olahan Daging</option>
															</select>
														</td>
														<td>
															<center>
